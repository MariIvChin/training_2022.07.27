...
function getCalcResult() {
  const numOne = parseFloat(document.getElementById("num1").value);
  const numTwo = parseFloat(document.getElementById("num2").value);
...
// const operator = document.getElementById("operator").value;
// const calcResult = document.getElementById("result").value;
...
// const fromNum = document.getElementById("from");
// const toNum = document.getElementById("to");
// const stepNum = document.getElementById("step");
const calcStepResult = document.getElementById("step-result");

function getCalcStepResult() {
  const fromNum = parseFloat(document.getElementById("from").value);
  const toNum = parseFloat(document.getElementById("to").value);
  const stepNum = parseFloat(document.getElementById("step").value);
  let html = "<ul class='list-group list-group-horizontal overflow-auto'>";
  for (let i = fromNum; i <= toNum; i += stepNum) {
    console.log(i);
    html += `<li class="list-group-item"> ${i} </li>`;
  }
  html += "</ul>";
  calcStepResult.innerHTML = html;
}
